...
class ImageEditorPro extends StatefulWidget {
  ...
  final bool disableBrushTab;
  final bool disableTextTab;
  final bool disableFlipTab;
  final bool disableRotateTabs;
  final bool disableBlurTab;
  final bool disableEraserTab;
  final bool disableFilterTab;
  final bool disableEmojiTab;
  ...
  ImageEditorPro({
    ...
    this.disableBrushTab = false,
    this.disableTextTab = false,
    this.disableFlipTab = false,
    this.disableRotateTabs = false,
    this.disableBlurTab = false,
    this.disableEraserTab = false,
    this.disableFilterTab = false,
    this.disableEmojiTab = false,
  });
                    ...
                    builder: (context) {
                      return StatefulBuilder(
                        builder: (context, setS) {
                          ...
                          color: Colors.black87, height: 300, borderRadius: BorderRadius.only(topRight: Radius.circular(10), topLeft: Radius.circular(10)));
                    });
              },
              title: 'Filter',
            ),
      widget.disableEmojiTab
          ? null
          : BottomBarContainer(
              colors: widget.bottomBarColor,
